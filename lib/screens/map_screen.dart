...
class MapScreenState extends State<MapScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (isLoading) {
      expandedChild = Center(child: CircularProgressIndicator(value: null, color: colorPrimary,));
  ...
  Future<Null> showDetailPlace(String placeId) async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => MapDetailWidget(placeId)),
    );
  }
